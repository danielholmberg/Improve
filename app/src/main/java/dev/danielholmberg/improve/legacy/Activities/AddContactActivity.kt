...
import dev.danielholmberg.improve.legacy.Utilities.ContactInputValidator
...
class AddContactActivity : AppCompatActivity() {
    ...
    private fun initActivity() {
        ...
        val contactBundle = intent.getBundleExtra(dev.danielholmberg.improve.legacy.Activities.AddContactActivity.Companion.CONTACT_BUNDLE_KEY)
        if (contactBundle != null) {
            contact = contactBundle.getParcelable<Parcelable>(dev.danielholmberg.improve.legacy.Activities.AddContactActivity.Companion.CONTACT_KEY) as Contact?
        }
        if (contact != null) {
            isEdit = true
        ...
        preSelectedCompany = intent.getParcelableExtra<Parcelable>(dev.danielholmberg.improve.legacy.Activities.AddContactActivity.Companion.PRE_SELECTED_COMPANY) as Company?
    ...
    private fun showParentActivity() {
        restUI()
        startActivity(Intent(this, dev.danielholmberg.improve.legacy.Activities.MainActivity::class.java))
    ...
    companion object {
        private val TAG = dev.danielholmberg.improve.legacy.Activities.AddContactActivity::class.java.simpleName
