...
import dev.danielholmberg.improve.legacy.Fragments.CompanyDetailsDialogFragment
...
class CompanyViewHolder(private val mView: View) : RecyclerView.ViewHolder(
    ...
    fun bindModelToView(company: Company) {
        ...
        quickAddNewContact!!.setOnClickListener {
            val addContactIntent = Intent(instance, dev.danielholmberg.improve.legacy.Activities.AddContactActivity::class.java)
            addContactIntent.putExtra(dev.danielholmberg.improve.legacy.Activities.AddContactActivity.PRE_SELECTED_COMPANY, company)
