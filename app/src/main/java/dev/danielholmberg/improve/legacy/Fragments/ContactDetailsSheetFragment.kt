        ...
        toolbar!!.setOnMenuItemClickListener { item ->
            when (item.itemId) {
                R.id.contactEdit -> {
                    ...
                    val updateContact = Intent(instance!!, dev.danielholmberg.improve.legacy.Activities.AddContactActivity::class.java)
                    updateContact.putExtra(dev.danielholmberg.improve.legacy.Activities.AddContactActivity.CONTACT_BUNDLE_KEY, contactBundle)
