package dev.danielholmberg.improve.clean.feature_contact.presentation
...
import dev.danielholmberg.improve.clean.feature_contact.domain.util.ContactInputValidator
import java.util.*
...
class AddContactActivity : AppCompatActivity() {
    ...
    private fun addContact() {
        ...
        val id = contactRepository.generateNewContactIdForCompany(company.id!!)
    ...
    private fun updateContact() {
        ...
        contactRepository.updateContact(contact!!, updatedContact)
        showParentActivity()
    }
