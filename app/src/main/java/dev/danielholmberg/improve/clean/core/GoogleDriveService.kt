 ...
 */
class GoogleDriveService(private val mDriveService: Drive) {
    private val mExecutor: Executor = Executors.newSingleThreadExecutor()

    /**
     * Creates a text file in the user's My Drive folder and returns its file ID.
     */
    fun createFile(mimeType: String?, fileName: String?, content: String?): Task<String> {
 ...
 * Developer's Console](https://play.google.com/apps/publish) and be submitted to Google for verification.
    ...
    companion object {
        const val TYPE_NOTE = "text/plain"
        const val TYPE_CONTACT = "text/vcard"
    }
}