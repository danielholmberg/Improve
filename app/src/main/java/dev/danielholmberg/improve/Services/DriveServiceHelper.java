...
public class DriveServiceHelper {
    ...
    public static final String TYPE_CONTACT = "text/vcard";
     ...
     */
    public Task<String> createFile(String mimeType, String fileName, String content) {
     ...
     * created by {@link #createFilePickerIntent(String)} using the given {@code contentResolver}.
     */
